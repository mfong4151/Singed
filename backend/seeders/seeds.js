...
//Use this format for uploading to render
// const restaurants = easySeeds.formatSeeds(process.cwd().concat('/backend/seeders/seed_files/restaurant_seeds.csv'))


//Use this format for local changes
